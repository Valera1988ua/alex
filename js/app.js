    ...
    function tabs() {
        ...
        function setTabsStatus(tabsBlock) {
            ...
            function isTabsAnamate(tabsBlock) {
                if (tabsBlock.hasAttribute("data-tabs-animate") && tabsBlock.classList.contains("_tab-spoller")) return tabsBlock.dataset.tabsAnimate > 0 ? Number(tabsBlock.dataset.tabsAnimate) : 500;
            }
    ...
    function formFieldsInit(options = {
        ...
        document.body.addEventListener("focusout", (function(e) {
            ...
            if ("INPUT" === targetElement.tagName || "TEXTAREA" === targetElement.tagName) {
                ...
                if (!targetElement.hasAttribute("data-no-focus-classes")) if (targetElement.value.length > 1) return; else {
